      ...
      >
        <CardHeader className="pb-2 p-2.5 sm:p-3 md:p-4">
          ...
          <div className="flex items-start justify-between gap-2">
            <div className="flex items-center gap-1.5">
              <Badge
                ...
                className={cn(
                  'font-press-start text-[9px] px-1.5 py-0.5 flex items-center gap-1',
                  team.rank === 1 &&
            ...
            <Badge
              variant="outline"
              className="font-press-start text-[8px] px-1.5 py-0.5 truncate max-w-[70px] bg-retro-green/20 text-retro-green border-retro-green"
            >
              {team.abbrev}
            </Badge>
          </div>
          ...
          <div className="mt-2">
            ...
            <p className="text-[10px] text-gray-400 font-mono mt-0.5">{team.owner}</p>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-2.5 sm:space-y-3 p-2.5 pt-2 sm:p-3 md:p-4 sm:pt-2">
          ...
          <div className="bg-retro-green/10 border border-retro-green/30 sm:border-2 rounded-lg p-2 sm:p-2.5">
            ...
            <div className="flex items-baseline gap-2 justify-between">
              ...
              <span className="text-base sm:text-lg text-retro-yellow font-mono">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="bg-black/40 border border-retro-green/20 rounded-lg p-2">
              <div className="text-[9px] text-gray-500 font-mono uppercase mb-0.5">Avg Pts</div>
              <div className="text-base sm:text-lg font-bold text-gray-300 font-mono">
            ...
            {/* Total Points */}
            <div className="bg-black/40 border border-retro-green/20 rounded-lg p-2">
              <div className="text-[9px] text-gray-500 font-mono uppercase mb-0.5">Total</div>
              <div className="text-base sm:text-lg font-bold text-retro-green font-mono">
